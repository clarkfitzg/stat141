---
title: "HW3 - Hotel bookings - data wrangling"
...
hotels <- read_csv("https://github.com/clarkfitzg/stat141/raw/refs/heads/main/data/hotels.csv")

# If that doesn't work, then on the cloud try:
#hotels <- read_csv("~/shared/stat141/data/hotels.csv")
```
...
Warm up! How many rows and columns are in this data?
...
Use ggplot to create a histogram of the average daily rate. First filter the data to exclude the obvious outliers. Include a title and informative x and y labels on the plot.
...
Come up with your own question about the hotels data, and use ggplot to create a visualization to answer the question. Comment on what your plot shows.
